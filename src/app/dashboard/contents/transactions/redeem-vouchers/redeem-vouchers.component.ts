...
@Component({
  selector: 'app-redeem-vouchers',
  templateUrl: './redeem-vouchers.component.html',
  styleUrls: ['./redeem-vouchers.component.css']
})
export class RedeemVouchersComponent implements AfterViewInit {
  query = '';
  fq = { // filter Query
    from_date: null,
    through_date: null,
  ...
  openFormExportToCSV() {
    this.dialog.open(DialogExportTransactionRedeemVouchersToCSVComponent, {
      width: '50%',
    });
  }
...
export class DialogExportTransactionRedeemVouchersToCSVComponent implements OnInit {
  ...
  constructor(
    public dialogRef: MatDialogRef<DialogExportTransactionRedeemVouchersToCSVComponent>,
